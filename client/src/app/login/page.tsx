...
function Login() {
    return (
        <div className='h-[40rem] md:overflow-hidden  w-full md:h-screen mx-auto flex flex-row'>
            <div className='invisible md:visible md:w-1/2 bg-purple-300 relative'>
                <ImagesSliderDemo />
            </div>
            <div className='w-full md:w-1/2 bg-purple-600 relative'>
                ...
                <div className=' w-4/6 mx-auto flex flex-col justify-center h-full'>
                    <div className='my-3'>
                        <h1 className='text-white text-center text-xl md:text-[2rem] font-bold my-1'>Connectez-vous à votre compte!</h1>
                        <p className=' text-white text-sm md:text-base text-center mx-20'>Veuillez saisir votre e-mail et votre mot de passe pour vous connecter, <b>Merci.</b></p>
                    </div>
                    <Label className='my-2 text-white' htmlFor='email'>E-mail</Label>
                    <Input className='mb-1 focus:border-purple-600 outline-none' type='email' placeholder='nom@exemple.domaine' />
                    <Label className='my-2 text-white' htmlFor='password'>Mot de passe</Label>
                    <Input className='mb-1 focus:border-purple-600 outline-none' type='password' placeholder='Votre mot de passe' />
                    <Button variant="secondary" className='mt-2'>Se Connecter</Button>
